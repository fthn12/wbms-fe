...
const CreateTransportvehicle = ({ isOpen, onClose, dtCompanies, dtProduct }) => {
  const { useCreateTransportVehicleMutation } = useTransportVehicle();
  const [createTransportVehicle, { isLoading }] = useCreateTransportVehicleMutation();
  const handleSubmit = (values, { setSubmitting, resetForm }) => {
    ...
    try {
      createTransportVehicle(values).then((results) => {
